---
page_title: "os-v1 Provider"
---

# os-v1 Provider

This provider is used to interact with the resources provided by the **os-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
